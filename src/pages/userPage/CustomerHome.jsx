            ...
            {vehicles && vehicles.map((vehicle, index) => (
              <div className='mx-3 mt-3 shadow-xl rounded-xl' key={index}>
                ...
                <div className='py-5 px-6 flex justify-between items-center'>
                  ...
                  <Link to={'/carInfo/' + vehicle.vin}><p className='text-blue-600 font-medium text-[11px] flex items-center'>View Details <img className='ml-2 w-3 h-3' src={arrowIcon} alt="" /></p></Link>
                </div>
